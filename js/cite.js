...
$(function() {
  ...
  // The following test might seem stupid, but it's needed because some php function at
  // OpenPsych appends two whitespaces to the start of the title in the meta data
  if (title[1] == ' ') {
    title = title.slice(2)
  }
